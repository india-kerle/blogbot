...
class ModelParamsConfig(BaseModel):
    ...
    #we are using a small-ish LLM (7B) for this task
    #future work could be to use a much larger model for better performance
...
class DataConfig(BaseModel):
    ...
    #We take a stratified sample of blogposts by different groups for text diversity
    #Future work could include testing performance
